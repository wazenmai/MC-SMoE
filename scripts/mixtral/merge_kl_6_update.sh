accelerate launch --config_file static/finetune_config.yaml \
  ...
  --eval_batch_size=32 \
  --partition=1 \
  --output_path="/app/results/mc-smoe/mixtral8x7b/merge-6e/kl-dom-router-logits-group-zipit-dom-group-merge-50k" |& tee results/log_6e_kl-dom-router-logits-group-zipit-dom-group-merge-50k
...
accelerate launch --config_file static/finetune_config.yaml \
  ...
  --eval_batch_size=32 \
  --partition=1 \
  --output_path="/app/results/mc-smoe/mixtral8x7b/merge-6e/kl-dom-router-logits-group-zipit-update-merge-50k" |& tee results/log_6e_kl-dom-router-logits-group-zipit-update-merge-50k
...
accelerate launch --config_file static/finetune_config.yaml \
  ...
  --eval_batch_size=32 \
  --partition=1 \
  --output_path="/app/results/mc-smoe/mixtral8x7b/merge-6e/kl-dom-weight-group-zipit-dom-group-merge-50k" |& tee results/log_6e_kl-dom-weight-group-zipit-dom-group-merge-50k
