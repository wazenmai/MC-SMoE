...
def merge_mixtral_moe_by_activation_matching_within_and_across_models(
    ...
    concat_ffn.w1.weight.data = ffn_all_w1.to(torch.float)
    concat_ffn.w2.weight.data = ffn_all_w2.to(torch.float)
    concat_ffn.w3.weight.data = ffn_all_w3.to(torch.float)
